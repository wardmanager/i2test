...
export class AuthService {
  ...
  auth0 = new Auth0({clientID: 'AESpTdukHIe9KnNpwDQfpvguOBHp9409', domain: 'wardmanager.auth0.com' });
  lock = new Auth0Lock('AESpTdukHIe9KnNpwDQfpvguOBHp9409', 'wardmanager.auth0.com', {
    auth: {
      redirect: false,
      params: {
